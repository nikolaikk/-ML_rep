...
# -*- coding: utf-8 -*-
"""
Created on Fri May 31 13:56:07 2019
...
#    list_k_neighbours=sorted(list_k_neighbours,key=getKey)
    list_k_neighbours =[list(list_k_neighbours[i]) for i in list(np.argsort(np.array(list_k_neighbours)[:,1]))]
...
if __name__ == "__main__":
    ...
    x, labels = make_blobs(n_samples=100, centers=3, n_features=3, random_state=0)
